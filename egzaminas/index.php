...
<div class="col-md-12">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><a href="filtravimas.php?id=<?php echo $autorius['id'] ?>" class="btn btn-primary">Plačiau</a></td>
            <td><a href="autorius_redaguoti.php?id=<?php echo $autorius['id'] ?>" class="btn btn-warning">Redaguoti</a></td>
            <td> <form method="post">
...
<div class="col-md-12">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><a href="knyga_redaguoti.php?id=<?php echo $knyga['id'] ?>" class="btn btn-warning">Redaguoti</a></td>
                 <td><form method="post">
